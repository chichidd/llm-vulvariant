...
- Pure evaluation datasets/benchmarks: classify under **Evaluation, Testing & Benchmarking** unless it is a general data pipeline.
- Retrieval logic tightly coupled to a RAG framework can be split: storage/index under Data & Knowledge; orchestration under **RAG & Tooling**.
