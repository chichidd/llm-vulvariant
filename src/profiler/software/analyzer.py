...
class SoftwareProfiler:
    ...
    def _generate_profile_full(
        ...
        profile = SoftwareProfile(
            ...
            capabilities=basic_info.get("capabilities", []),
            interfaces=basic_info.get("interfaces", []),
            deployment_style=basic_info.get("deployment_style", []),
            operator_inputs=basic_info.get("operator_inputs", []),
            external_surfaces=basic_info.get("external_surfaces", []),
            evidence_summary=basic_info.get("evidence_summary", ""),
            confidence=basic_info.get("confidence", "unknown"),
